...
namespace Bundos.MovingPlatforms
{
    ...
    public class PlatformController : MonoBehaviour
    {
        ...
        private Transform playerOnPlatform; // Reference to the player on the platform
        ...
        private void MoveToWaypoint(Vector3 waypoint)
        {
            ...
            // If player is on the platform, move the player with the platform
            if (playerOnPlatform != null)
            {
                playerOnPlatform.position += (Vector3)direction * moveSpeed * Time.deltaTime;
            }
        }
        ...
        {
            // Check if the collided object is the player and it's the one we have reference to
